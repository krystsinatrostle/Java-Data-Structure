 ...
 *
 * The objective of the program is to define the WorkWithStacks class
...
public class WorkWithStacks {
    private Stack<ContactNames> stackContacts; 
    private Stage stage = new Stage();
    GridPane contactPane = new GridPane();

    public WorkWithStacks()
    {
        stackContacts = new Stack<>();
        ...
        stage.setTitle("Data Structure - Stack Contact Names and Phone Numbers");
        stage.show();
    }
    ...
    private void rebuildContactPane() {
        ...
        for (int i = 0; i < stackContacts.size(); i++) {
            ContactNames contact = stackContacts.get(i);
    ...
    private void buildComponents(GridPane gridPane)
    {
        ...
        labelForStack.setFont(Font.font("Tahoma", FontWeight.BOLD, 15));
        // Add the label to the GridPane
        gridPane.add(labelForStack, 1, 0, 2, 1);
        ...
        buttonToAddToStack.setOnAction(event ->
        {
            ...
            stackContacts.add(contactNameObject);
        ...
        buttonToAddToStack.setStyle(IDLE_BUTTON_STYLE);
        buttonToAddToStack.setOnMouseEntered(e -> 
                buttonToAddToStack.setStyle(HOVERED_BUTTON_STYLE));
        buttonToAddToStack.setOnMouseExited(e -> 
                buttonToAddToStack.setStyle(IDLE_BUTTON_STYLE));
        ...
        buttonToSort.setOnAction(event ->
        {
            ...
            Collections.sort(stackContacts, comp);
            rebuildContactPane();
        });
        ...
        {
            Label displayCount = new Label("" + stackContacts.size());
        ...
        buttonToSearch.setOnAction(event ->
        {
            ...
            for (ContactNames contact : stackContacts) {
        ...
        buttonToRemove.setOnAction(event ->
        {
            ...
            for (int i = 0; i < stackContacts.size(); i++)
            {
                ...
                if (stackContacts.get(i).getContactName().equals(holdContactName))
                {
                    stackContacts.remove(stackContacts.get(i));
                    removeSwitch = true;
                }
        ...
        // Create a button to exit the WorkWithStacks program
        Button buttonToExit = new Button("Exit the Stack Program");
        // Add the button to the GridPane
