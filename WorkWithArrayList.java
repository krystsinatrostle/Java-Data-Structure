 ...
 *
 * The objective of the program is to define the WorkWithArrayList class
...
public class WorkWithArrayList {  
    private ArrayList<ContactNames> arrayListContacts; 
    private Stage stage = new Stage();
    GridPane contactPane = new GridPane();
    
    public WorkWithArrayList()
    {
        ...
        stage.setHeight(700);
        stage.setWidth(600);
        stage.setTitle("Data Structure - ArrayList Contact Names and Phone Numbers");
    ...
    private void rebuildContactPane() {
        ...
        for (int i = 0; i < arrayListContacts.size(); i++) {
            ContactNames contact = arrayListContacts.get(i);
    ...
    private void buildComponents(GridPane gridPane)
    {
        ...
        Label labelForArrayList = new Label("Create and Work with an ArrayList "); 
        labelForArrayList.setFont(Font.font("Tahoma", FontWeight.BOLD, 15));
        // Add the label to the GridPane
        gridPane.add(labelForArrayList, 1, 0, 2, 1);
        ...
        Button buttonToAddToArrayList = new Button("Add a Contact Name and "
                + "Phone Number");
        // Add the button to the GridPane
        gridPane.add(buttonToAddToArrayList, 2, 4, 3, 1);

        // Event handler for the add button to add contact name and phone number
        // and throw exception if the fields are empty        
        buttonToAddToArrayList.setOnAction(event ->
        {
            ...
            arrayListContacts.add(contactNameObject);
        ...
        buttonToAddToArrayList.setStyle(IDLE_BUTTON_STYLE);
        buttonToAddToArrayList.setOnMouseEntered(e -> 
                buttonToAddToArrayList.setStyle(HOVERED_BUTTON_STYLE));
        buttonToAddToArrayList.setOnMouseExited(e -> 
                buttonToAddToArrayList.setStyle(IDLE_BUTTON_STYLE));
        ...
        buttonToSort.setOnAction(event ->
        {
            ...
            Collections.sort(arrayListContacts, comp);
            rebuildContactPane();
        });
        ...
        {
            Label displayCount = new Label("" + arrayListContacts.size());
        ...
        labelSearchMessage.setVisible(false);
        ...
        buttonToSearch.setOnAction(event ->
        {
            ...
            for (ContactNames contact : arrayListContacts) {
        ...
        buttonToRemove.setOnAction(event ->
        {
            ...
            for (int i = 0; i < arrayListContacts.size(); i++)
            {
                ...
                if (arrayListContacts.get(i).getContactName().equals(holdContactName))
                {
                    arrayListContacts.remove(arrayListContacts.get(i));
                    removeSwitch = true;
                }
        ...
        // Create a button to exit the WorkWithArrayList program
        Button buttonToExit = new Button("Exit the ArrayList Program");
        // Add the button to the GridPane
